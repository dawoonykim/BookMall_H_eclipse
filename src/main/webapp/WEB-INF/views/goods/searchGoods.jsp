                        ...
                        <li>
                            <div id="book2">
                                <a href="${contextPath}/goods/goodsDetail.do?goodsId=${item.goodsId}">
                                    <img width="75" alt="" src="${contextPath}/thumbnails.do?goodsId=${item.goodsId}&goodsFileName=${item.goodsFileName}">
                                </a>
    ...
    <c:forEach var="item" items="${goodsList }">
        <tr>
            ...
            <td class="goods_description">
                ...
                <c:set var="arr" value="${fn:split(goodsPubDate,' ')}" />
...
<div id="page_wrap">
    <ul id="page_control">
        ...
        <c:forEach var="count" begin="1" end="10" step="1">
            <c:choose>
                <c:when test="${count==1 }">
                    <li><a class="page_contrl_active" href="#">${count+pageNum*10 }</a></li>
                </c:when>
                <c:otherwise>
                    <li><a href="#">${count+pageNum*10 }</a></li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
