...
<c:forEach var="item" items="${myOrderList}">
    <c:set var="total_order_price" value="${total_order_price+item.goodsPrice* item.orderGoodsQty}"/>
    <c:set var="total_discount_price" value="${total_discount_price+item.goodsPrice-item.goodsPrice*0.9}"/>
    <c:set var="total_delivery_price" value="${total_delivery_price+item.goodsDeliveryPrice}"/>
</c:forEach>
...
<form name="form_order">
    <table class="list_view">
        ...
        <c:set var="final_total_order_price"
               value="${final_total_order_price+ item.goodsPrice*0.9* item.orderGoodsQty+item.goodsDeliveryPrice}"/>
