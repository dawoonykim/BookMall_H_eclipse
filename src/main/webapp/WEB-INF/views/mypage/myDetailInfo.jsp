...
<head>
	...
	<script>
		...
		function selectBoxInit(){
			...
			var val;
			console.log("selectBoxInit 여기 까지 동작합니다.1")
			...
			console.log("selectBoxInit 여기 까지 동작합니다.2")
		...
		function fn_modify_member_info(attribute){
			console.log("fn_modify_member_info 여기 까지 동작합니다.1")
			var value;
			// alert(member_id);
			...
			if(attribute=='memberPw'){
				...
				console.log("fn_modify_member_info 여기 까지 동작합니다.2")
				...
				for(var i=0; member_gender.length;i++){
					if(member_gender[i].checked){
						...
						console.log("fn_modify_member_info 여기 까지 동작합니다.3")
						break;
					}
				}

			}else if(attribute=='memberBirth'){
				console.log("fn_modify_member_info 여기 까지 동작합니다.4")
				...
				for(var i=0; member_birth_y.length;i++){
					if(member_birth_y[i].selected){
						console.log("fn_modify_member_info 여기 까지 동작합니다.5")
				...
				for(var i=0; member_birth_m.length;i++){
					if(member_birth_m[i].selected){
						console.log("fn_modify_member_info 여기 까지 동작합니다.6")
				...
				for(var i=0; member_birth_d.length;i++){
					if(member_birth_d[i].selected){
						console.log("fn_modify_member_info 여기 까지 동작합니다.7")
				...
				for(var i=0; member_birth_gn.length;i++){
					if(member_birth_gn[i].checked){
						console.log("fn_modify_member_info 여기 까지 동작합니다.8")
				...
				console.log("fn_modify_member_info 여기 까지 동작합니다.9")
				...
				for(var i=0; tel1.length;i++){
					if(tel1[i].selected){
						console.log("fn_modify_member_info 여기 까지 동작합니다.10")
				...
				console.log("fn_modify_member_info 여기 까지 동작합니다.11")
				...
				console.log("fn_modify_member_info 여기 까지 동작합니다.15")
				...
				console.log("fn_modify_member_info 여기 까지 동작합니다.16")
	...
	<div id="detail_table">
		<table>
			...
			<tr class="dot_line">
				...
				<td>
					<input name="member_id" type="text" size="20" value="${memberInfo.memberId }"  disabled/>
				</td>
				<td>
				</td>
			</tr>
			...
			<tr class="dot_line">
				...
				<td>
					<input name="member_name" type="text" size="20" value="${memberInfo.memberName }"  disabled />
				</td>
				<td>
				</td>
			</tr>
		...
		<table align=center>
			<tr>
				<td >
					...
					<input name="btn_cancel_member" type="button" value="수정 취소" onclick="window.location.href='${contextPath}/mypage/myPageMain.do'">
